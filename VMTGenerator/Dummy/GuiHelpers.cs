...
namespace N64Application.Tool.Utils
{
    ...
    class GuiHelper
    {
        ...
        private static readonly string FilterWrl = "VRML files (*.wrl)|*.wrl";
        private static readonly string FilterObj = "Wavefront obj (*.obj)|*.obj";
        private static readonly string FilterMtl = "Wavefront mtl (*.mtl)|*.mtl";
        private static readonly string FilterSmd = "Studiomdl Data (*.smd)|*.smd";
        private static readonly string FilterBmp = "Bitmap (*.bmp) | *.bmp";
        private static readonly string FilterPng = "Portable Network Graphics (*.png) | *.png";
        private static readonly string FilterJpeg = "Jpeg files (*.jpg, *.jpeg, *.jpe, *.jfif) | *.jpg; *.jpeg; *.jpe; *.jfif";
        private static readonly string FilterImage = "Image files (*.jpg, *.jpeg, *.jpe, *.jfif, *.bmp, *.png) | *.jpg; *.jpeg; *.jpe; *.jfif; *.bmp; *.png";

        private static readonly string WrlToObjName = "output";
        private static readonly string DeleteMaterialName = "untextured";
        private static readonly string DeleteUnusedMaterialName = "deleted_texture";
        private static readonly string AddMaterialName = "textured";
        private static readonly string ModifyObjName = "modified";
        private static readonly string MergedObjName = "merged";
        private static readonly string ExportedSmdName = "exported";
        private static readonly string DefaultName = "default";

        private static readonly string FolderSelection = "[Folder Selection]";

        //public static readonly string ExtensionPatternObj = "*.obj";

        public static readonly string ExtensionWrl = ".wrl";
        public static readonly string ExtensionObj = ".obj";
        public static readonly string ExtensionSmd = ".smd";
